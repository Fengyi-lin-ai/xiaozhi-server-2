...
class TTSProvider(TTSProviderBase):
    ...
    async def text_to_speak(self, text, output_file):
        ...
        # # testCode
        # text = "你好,我是科技馆欧比,有什么能为你服务的吗"
        websocket = await websockets.connect(
            self.api_url, additional_headers=self.header, max_size=10 * 1024 * 1024
        )
        logger.info(
        ...
        try:
            ...
            for i, sentence in enumerate(sentences):
                ...
                if self.cot and self.cot != "":
                    base_request["req_params"]["audio_params"]["emotion"] = self.cot
                # Start session
